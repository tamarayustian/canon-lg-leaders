    ...
    <article className="pkm-card w-full max-w-[340px] mx-auto">
      <div className="pkm-frame">
        ...
        <div className="flex items-center justify-between px-3 pt-2 pb-1">
          <h3
            className="font-bold text-[hsl(var(--pkm-ink))] text-lg"
            style={{
          ...
          <div className="flex items-center gap-1">
            <span className="text-[10px] font-bold text-[hsl(var(--pkm-ink))]">
              HP
            </span>
            <span
              className="text-xl font-extrabold text-[hsl(var(--pkm-red))]"
              style={{ fontFamily: "'Bebas Neue', sans-serif" }}
            >
              {hp}
            </span>
            <span
              className="ml-1 w-6 h-6 rounded-full flex items-center justify-center text-xs border-2 border-[hsl(var(--pkm-ink))]"
        ...
        {/* Art */}
        <div
          className={`mx-2 rounded-md ${showImages && s.imageUrl ? 'pkm-art-image' : 'pkm-art'}`}
        >
          ...
          <span className="absolute bottom-1 right-2 text-[9px] font-bold text-[hsl(var(--pkm-ink))] bg-white/70 px-1.5 rounded z-10">
        ...
        <div className="px-3 py-2 border-y-2 border-[hsl(var(--pkm-ink))] mt-2 mx-2 bg-[hsl(48_60%_85%)]">
          <div className="flex items-center justify-between">
            <span
              className="font-extrabold text-[hsl(var(--pkm-ink))] uppercase text-sm tracking-wide"
              style={{
                fontFamily: "'Bebas Neue', sans-serif",
            ...
            <span className="text-xs font-bold text-[hsl(var(--pkm-ink))]">
              +{20 + (i % 4) * 10}
            </span>
          </div>
          <p className="text-[11px] leading-snug text-[hsl(var(--pkm-ink))] mt-1 italic">
            "{s.memory}"
          </p>
        </div>
        ...
        <div className="px-3 py-3 mx-2">
          <p
            className="text-[11px] leading-relaxed text-[hsl(var(--pkm-ink))]"
        ...
        <div className="flex items-center justify-between px-3 pb-2 pt-1 mx-2 border-t border-[hsl(var(--pkm-ink))]/40">
          <span className="text-[9px] text-[hsl(var(--pkm-ink))]/70">
            CANON LG • 2026
          </span>
          <span className="text-[9px] font-bold text-[hsl(var(--pkm-ink))]">
            ★ RARE HOLO
          </span>
        </div>
      </div>
  ...
  return (
    <main className="pkm-page min-h-screen">
      ...
      <header className="container mx-auto px-6 pt-10 pb-6 gap-x-3 flex items-center justify-between">
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            className="pkm-badge px-3 py-2 text-[10px]"
          >
      ...
      <section className="container mx-auto px-6 py-10 text-center">
        <p className="pkm-title text-[10px] md:text-xs text-[hsl(var(--pkm-yellow))] mb-6">
        ...
        <p className="max-w-xl mx-auto text-white/85 text-sm md:text-base">
          20 trainer cards from your LIFE Group. Each one a trait, a memory, a
          message — all for you.
        </p>
      ...
      <section className="container mx-auto px-6 pb-24">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-10">
          {shuffled.map((s, i) => (
            <TrainerCard key={s.member} s={s} i={i} showImages={showImages} />
          ))}
        </div>
      </section>

      <footer className="text-center pb-10 text-xs text-white/60 pkm-title">
        ★ COLLECT ALL 20 ★
      </footer>
    </main>
  );
